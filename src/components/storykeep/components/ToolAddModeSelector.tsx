  ...
  return (
    <div className="flex items-center">
      ...
      <select
        ...
        className="block w-fit-contents rounded-md border-0 py-1.5 pl-3 pr-10 text-mydarkgrey ring-1 ring-inset ring-mylightgrey focus:ring-2 focus:ring-myblue xs:text-sm xs:leading-6"
      >
